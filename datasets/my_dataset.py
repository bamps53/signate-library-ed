...
class MyDataset(Dataset):
    ...
    def __init__(self, root_dir, set_name, mode, transform=None):
        """
        Args:
        ...
        print()
        print(os.path.join(self.root_dir, set_name))
        print()
        self.coco = COCO(os.path.join(self.root_dir, '{}_coco.json'.format(self.set_name)))
